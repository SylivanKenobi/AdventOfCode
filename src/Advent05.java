...
public class Advent05 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < opcodeList.size(); ) {
            ...
            instructions.add("0");
            instructions.add("0");
            if (instructions.get(0).equals("9")) {
                System.out.println("asd");
            }
            opcode = instructions.get(0).equals("9") ? (instructions.get(0) + instructions.get(1)) : instructions.get(0);
            ...
            switch (opcode) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    // Ask User for number Input put it in address provided by parameter
