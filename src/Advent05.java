...
//            System.out.println(opcode);
            switch (opcode) {
                case "99":
                    ...
                    break;
                case "1":
                    value1 = instructions.get(2).equals("0") ? opcodeList.get(opcodeList.get(i + 1)) : opcodeList.get(i + 1);
                    value2 = instructions.get(3).equals("0") ? opcodeList.get(opcodeList.get(i + 2)) : opcodeList.get(i + 2);
                    index = instructions.get(4).equals("0") ? opcodeList.get(i + 3) : i + 3;
                    opcodeList.set(index, value1 + value2);
                    i += 4;
                    break;
                case "2":
                    value1 = instructions.get(2).equals("0") ? opcodeList.get(opcodeList.get(i + 1)) : opcodeList.get(i + 1);
                ...
                case "3":
                    ...
                    index = instructions.get(2).equals("0") ? opcodeList.get(i + 1) : i + 1;
                    opcodeList.set(index, scanned);
                    i += 2;
                    break;
                case "4":
                    index = instructions.get(2).equals("0") ? opcodeList.get(i + 1) : i + 1;
                ...
                case "5":
                    value1 = instructions.get(2).equals("0") ? opcodeList.get(opcodeList.get(i + 1)) : opcodeList.get(i + 1);
                    if (value1 != 0) {
                        i = instructions.get(3).equals("0") ? opcodeList.get(opcodeList.get(i + 2)) : opcodeList.get(i + 2);
                    } else {
                        i += 3;
                    }
                ...
                case "7":
                    ...
                    index = instructions.get(4).equals("0") ? opcodeList.get(i + 3) : i + 3;
                    if (value1 < value2) {
                        opcodeList.set(index, 1);
                    } else {
                        opcodeList.set(index, 0);
                    }
                    i += 4;
                    break;
                case "8":
