    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < cable2.length; i++) {
            ...
            for (int j = 0; j < distance; j++) {
                ...
                if (line.containsKey(newX + "_" + newY)) {
                    minDist = Math.min(minDist, Math.abs(newX) + Math.abs(newY));
                    minSteps = Math.min(minSteps, line.get(newX + "_" + newY) + totalDistance);                }
                x = newX;
                y = newY;
            }
        }
